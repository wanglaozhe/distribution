...
public class SecuritySettings {
    ...
    private String permitCrossDomainReqUrls;
	...
	public String getPermitCrossDomainReqUrls() {
		return permitCrossDomainReqUrls;
	}

	public void setPermitCrossDomainReqUrls(String permitCrossDomainReqUrls) {
		this.permitCrossDomainReqUrls = permitCrossDomainReqUrls;
	}
