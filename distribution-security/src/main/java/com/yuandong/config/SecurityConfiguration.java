...
import com.yuandong.service.CustomUserDetailsService;
import com.yuandong.service.LoginSuccessHandler;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private CsrfSecurityRequestMatcher csrfSecurityRequestMatcher(){
        ...
        list.addAll(Arrays.asList(settings.getPermitCrossDomainReqUrls().split(",")));
        CsrfSecurityRequestMatcher csrfSecurityRequestMatcher = new CsrfSecurityRequestMatcher(list);
