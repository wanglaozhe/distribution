 ...
 */
@Data
public class PayResultVo extends BaseSignObject {

	//此字段是通信标识，非交易标识，交易是否成功需要查看result_code来判断
	private String result_code;
 
	//返回信息 return_msg 否 String(128) 返回信息，如非空，为错误原因  如：签名失败 参数格式校验错误
	...
	//CASH--充值代金券 NO_CASH---非充值代金券 并且订单使用了免充值券后有返回（取值：CASH、NO_CASH）。$n为下标,从0开始编号，举例：coupon_type_0
